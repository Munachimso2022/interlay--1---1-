    ...
    <section class="pt-120 pb-120">
      <div class="container">
        <div class="contact-wrapper">
          <div class="row">
            <div class="col-lg-6 contact-thumb bg_img"><img src="{{ getImage(imagePath()['logoIcon']['path'] . '/logo.png') }}" width="200" alt="Girl in a jacket" ></div>
            <div class="col-lg-6 contact-form-wrapper">
              <h2 class="font-weight-bold mb-2" style="color:#fcae04">@lang(@$contactContent->data_values->heading)</h2>
              <p class="font-weight-bold">Our customer services is always available if you any questions or queries about our services. Feel free to contact us using the provided fields below or chat our live agents. Thanks!</p>
              <form action="" method="post" class="contact-form mt-4">
                ...
                <div class="form-row">
                  ...
                  <div class="col-lg-12">
                    <button type="submit" class="btn btn-primary btn-md">@lang('Send Message')</button>
                  </div>
                </div>
              </form>
            </div>
