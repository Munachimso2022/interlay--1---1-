                    ...
                    @forelse($withdraws as $k=>$data)
                      <tr>
                        ...
                        <td data-label="@lang('Rate')">
                          ...
                          {{ getAmount($data->amount) }} {{ $general->cur_text }} =
                          {{ round($data->amount * $data->rate, 2) }} {{ $data->currency }}
                        </td>



                        <td data-label="@lang('Charge')">
                          <strong>{{ getAmount($data->charge) }} {{ $general->cur_text }} </strong> <br> or
                          {{ round($data->charge * $data->rate, 2) }} {{ $data->currency }}
                        </td>

                        <td data-label="@lang('Receivable')" class="text-success">
                          <strong>{{ getAmount($data->final_amount, currency()['fiat']) }}
