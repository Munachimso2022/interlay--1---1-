          ...
          <div class="nk-block">
            ...
            <div class="card card-bordered">
              <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                ...
                <button class="btn btn-dark close-button" type="button" title="@lang('Close Ticket')" data-toggle="modal"
                ...
                @if ($my_ticket->status != 4)
                  <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}"
                    ...
                    <div class="row justify-content-between">
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea name="message" class="form-control form-control-lg" id="inputMessage"
                    ...
                    <div class="row justify-content-between">
                      ...
                      <div class="col-md-12">
                        <div class="row justify-content-between">
                          ...
                          <div class="col-md-3 mt-3">
                            <div class="form-group">
                              <a href="javascript:void(0)" class="btn cmn-btn mt-4 extraTicketAttachment">
                      ...
                      <div class="col-md-12">
                        <button type="submit" class="btn cmn-btn w-100 mt-4" name="replayTicket" value="1">
      ...
      <div class="modal-content modal-content-bg">
        ...
        <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn cmn-btn" name="replayTicket" value="2"><i class="fa fa-check"></i>
              @lang("Confirm")
            </button>
          </div>
    ...
    $(document).ready(function() {
      ...
      $('.extraTicketAttachment').click(function() {
        $("#fileUploadsContainer").append(
          '<input type="file" name="attachments[]" class="form-control mt-1" required />')
      });
    });
  </script>
@endpush
