...
@section('content')
  ...
  {{-- @include($activeTemplate.'part   ials.user-breadcrumb') --}}
              ...
              <div class="table-responsive--md table-responsive">
                ...
                <div class="col-md-12">
                  <div class="right float-right my-3">
                    <a href="{{ route('user.deposit') }}" class="btn cmn-btn btn-primary">
                      @lang('Deposit Now')
                    </a>
                  </div>
                </div>
                        ...
                        <td data-label="@lang('Status')">
                          ...
                          @if ($data->admin_feedback != null)
                            <button class="btn-info btn-rounded  badge detailBtn"
                              data-admin_feedback="{{ $data->admin_feedback }}"><i class="fa fa-info"></i></button>
                          @endif
                        </td>
      ...
      <div class="modal-content modal-content-bg">
        ...
        <div class="modal-body">
          <ul class="list-group withdraw-list">
            ...
            <li class="list-group-item dark-bg">@lang('After Charge') : <span class="withdraw-after_charge"></span>
            </li>
    ...
    $(document).ready(function() {
      ...
      $('.approveBtn').on('click', function() {
        ...
        modal.find('.withdraw-detail').html(
          `<strong class="my-3 text-white">@lang('Payment Information')</strong>  ${singleInfo}`);
        modal.modal('show');
      });
