              ...
              <form action="{{ route('user.password.verify-code') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div id="phoneInput">
                    <div class="field-wrapper">
                      <div class=" phone">
                        <input type="text" name="code[]" class="letter" pattern="[0-9]*" inputmode="numeric"
                          maxlength="1">
                        <input type="text" name="code[]" class="letter" pattern="[0-9]*" inputmode="numeric"
                          maxlength="1">
                        <input type="text" name="code[]" class="letter" pattern="[0-9]*" inputmode="numeric"
                ...
                <div class="form-group">
                  <div class="btn-area  justify-content-center">
                    <button type="submit" class="btn-block btn btn-primary cmn-btn w-100">@lang('Verify
                      Code')</button>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <p class="mt-4">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a
                      href="{{ route('user.password.request') }}" class="forget-pass base--color"> @lang('Try to send
                      again')</a></p>
